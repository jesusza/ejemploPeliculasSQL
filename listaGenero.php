...
<html>
    <head>
        <meta charset="utf-8">
        <title>Listado por Género</title>
    ...
    <body>
        ...
        <nav aria-label="breadcrumb" class="container-fluid bg-light">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Listado Género</li>
            </ol>
        </nav>
        <?php    
              if (!isset($_POST['filtro'])) {
                ...
                <section class="container w-75 mt-2 bg-secondary p-3">
                    <form name="form1" id="form1" method="post" action="listaGenero.php">
                        <label class="form-label text-white">Introduzca el Genero a buscar</label>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $param = $cnx->prepare("SELECT id, titulo, genero, DATE_FORMAT(fechaInicio,'%d-%m-%Y') as 'fecha', DATE_FORMAT(fechaFin,'%d-%m-%Y') as 'fecha2' FROM peliculas WHERE genero like ? ORDER BY titulo, genero");
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6" class="text-center">
                                <a href="listaGenero.php" class="btn btn-secondary">Volver</a>
                            </td>
                        </tr>
                    </tfoot>
                </table>
